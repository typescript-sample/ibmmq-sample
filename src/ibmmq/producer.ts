...
export function createProducer<T>(conf: IBMMQConfig, logError: (msg: string) => void, logInfo?: (msg: string) => void): Producer<T> {
  return new Producer<T>(conf, logError, logInfo);
}
